...
const recoverySystem = [
  ...
  },
  {
    ...
    title: 'تكاملية القرار وتنسيق جهود',
  ...
  },
  {
    ...
    title: 'مشروعات إنتاج واستدامة',
    description: 'ترجمة التوافق المؤسسي إلى مشروعات عملية تدعم الخدمات الأساسية والإنتاج والتشغيل.',
    outcomes: ['توطين صناعة الطاقة الشمسية وحلول المياه', 'أسواق مخفّضة وسلاسل إمداد أكثر كفاءة', 'حاضنات وفرص عمل للشباب والمرأة'],
    color: 'teal',
  },
];
      ...
      <div className="container-x relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">
            ...
            وتحدث أثراً في حياة المواطن وتدعم التدفقات الصناعية والإنتاجية والتعافي الاقتصادي والاجتماعي.
          </p>
        </div>
        ...
        <div className="text-center mb-12">
          <div className="text-sm font-semibold text-teal-700 mb-3"> موجهات التشريعات والسياسات لـ </div>
