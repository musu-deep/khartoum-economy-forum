    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container-x relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="section-title">من الملتقى إلى المبادرة</h2>
          <p className="section-subtitle">
            لا يكون الهدف من الملتقى إصدار توصيات عامة فقط، بل الخروج بمبادرات قابلة للتنفيذ
            على أرض الواقع، تستثمر مسارات عمل مستمرة بعد الفعالية.
          </p>
        </div>
